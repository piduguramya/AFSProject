...
class Products1(models.Model):
    category=models.ForeignKey(Categories1, on_delete=models.CASCADE, related_name="prods")
...
class Product_item1(models.Model):
    product=models.ForeignKey(Products1, on_delete=models.CASCADE, related_name="prod_items")
...
class  Variation1(models.Model):
    category=models.ForeignKey(Categories1, on_delete=models.CASCADE,related_name="categories")
    variation_name=models.CharField(max_length=100)

    def __str__(self):
        return self.variation_name

class Variation_option1(models.Model):
    variation=models.ForeignKey(Variation1, on_delete=models.CASCADE,related_name="variations")
    value=models.CharField(max_length=100)

    def __str__(self):
        return self.value

class Product_Configuration1(models.Model):
    product_item=models.ForeignKey(Product_item1, on_delete=models.CASCADE,related_name="product_items")
    variationoption=models.ForeignKey(Variation_option1, on_delete=models.CASCADE,related_name="variation_options")
...
class ShoppingCartItems(models.Model):
    ...
    product_item=models.ForeignKey(Product_item1, on_delete=models.CASCADE,related_name="cart_items")
...
class Order_items(models.Model): # order_items_id is automatic
    ...
    items=models.ForeignKey(Product_item1, on_delete=models.CASCADE)
